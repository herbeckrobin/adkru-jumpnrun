...
export const GameConfigSchema = z.object({
  ...
  jumpVelocity: z.number().default(-30),
  ...
  baseSpeed: z.number().positive().default(3),
  /** Extra speed added per level */
  speedPerLevel: z.number().default(0.3),
  /** Background parallax base speed */
  bgScrollBase: z.number().default(1.5),
  /** Extra bg scroll speed per level */
  bgScrollPerLevel: z.number().default(0.5),
  ...
  groundOffset: z.number().default(50),
  ...
  playerWidth: z.number().positive().default(180),
  playerHeight: z.number().positive().default(200),
  playerStartX: z.number().default(100),
});
